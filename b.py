...
class Bridge(QObject):
    ...
    def printCoordinates(self, lat, lng):
        print(f"Clicked coordinates: {lat}, {lng}")
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(570, 100, 231, 20))
        font = QtGui.QFont()
        ...
        self.textEdit_3.setGeometry(QtCore.QRect(730, 40, 131, 31))
        self.textEdit_3.setObjectName("textEdit_3")

        self.label_5 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(650, 40, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.web_view.setGeometry(QtCore.QRect(50, 470, 981, 361))
    ...
    def add_to_list_view(self):
        ...
        for i in range(len(data['hourly']['time'])):
            ...
            latitude_item = QtGui.QStandardItem(f'{str(JalaliDatetime(datetime(date.year, date.month, date.day, date.hour, date.minute)))} = temp:{data["hourly"]["temperature_2m"][i]}, wind speed:{data["hourly"]["wind_speed_10m"][i]}\n')
            model.appendRow(latitude_item)

        longitude_item = QtGui.QStandardItem(f'maximum temp: {data["daily"]["temperature_2m_max"]}\nminimum temp: {data["daily"]["temperature_2m_min"]}\nsunrise: {data["daily"]["sunrise"]}\nsunset: {data["daily"]["sunset"]}\ncurrent temperature: {data["current"]["temperature_2m"]}\ncurrent wind speed: {data["current"]["wind_speed_10m"]}')
